			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="contactNumber" title="${message(code: 'client.contactNumber.label', default: 'Contact Number')}" />
					
						<th><g:message code="client.employee.label" default="Employee" /></th>
				...
				<g:each in="${clientInstanceList}" status="i" var="clientInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${clientInstance.id}">${fieldValue(bean: clientInstance, field: "contactNumber")}</g:link></td>
					
						<td>${fieldValue(bean: clientInstance, field: "employee")}</td>
