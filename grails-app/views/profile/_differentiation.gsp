<div id="differentiation${i}" class="entry-div" <g:if test="${hidden}">style="display:none;"</g:if>>
    <g:hiddenField name='differentiations[${i}].id' value='${service?.id}'/>
    <g:hiddenField name='differentiations[${i}].deleted' value='false'/>
	<g:hiddenField name='differentiations[${i}].new' value="${service?.id == null?'true':'false'}"/>
	...
	<g:textArea class="premium-field" name="differentiation[${i}].differentiationDescription" 
