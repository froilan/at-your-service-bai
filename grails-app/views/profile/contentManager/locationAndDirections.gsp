											...
											<ul class="input-wrap">
												<li class="user-input phil-address">
													<div class="inline-wrap line-1 blue-star">
														...
														<g:textField class="full-width" name="streetBuildingAddress" placeholder="Street/Building Address"
															value="${addressInstance?.streetBuildingAddress}"/>
													</div>
													<div class="inline-wrap line-2 blue-star">
														...
														<g:textField class="inline barangay half" name="barangay" placeholder="Barangay"
															value="${addressInstance?.barangay}" required="" />
														<g:textField class="inline city half" name="cityTown" placeholder="City/Town"
															value="${addressInstance?.cityTown}" required="" />
													</div>	
													<div class="inline-wrap line-3 blue-star">
														...
														<g:textField class="inline barangay half" name="province" placeholder="Province"
															value="${addressInstance?.province}" required="" />
														<g:textField class="inline zip-code half" name="zipCode" placeholder="Zip Code"
															value="${addressInstance?.zipCode}" required="" />
													</div>										
