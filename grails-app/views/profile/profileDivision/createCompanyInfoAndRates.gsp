 ...
 inquiries.</p>
											<ul class="input-wrap">							
												...
												<li class="user-input short-text">
													<input class="short" placeholder="$" type="text" required=""
														value="${profileInstance?.askingFee}"><span class="rate-type">/ hour</span>								
												</li>												
												<li class="user-input checkbox-wrap">
													<span class="line-wrap"><input name="rateNegotiable" value="${profileInstance?.rateNegotiable}" 
														type="checkbox"><span>Rate negotiable</span></span><br>
												</li>
											</ul>
										</li>
