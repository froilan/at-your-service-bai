	...
	<body>
		...
		<div id="show-profile" class="content scaffold-show" role="main">
			...
			<ol class="property-list profile">
				...
				<g:if test="${profileInstance?.contactInformation}">
				<li class="fieldcontain">
					<span id="contactInformation-label" class="property-label"><g:message code="profile.contactInformation.label" default="Contact Information" /></span>
					
						<g:each in="${profileInstance.contactInformation}" var="c">
